...
const HeroSession = () => {
  return (
    <div className="w-full h-auto relative flex justify-center items-center pb-14 mt-4">
      ...
      {/* Card Section */}
      <div className="absolute dark:bg-[#181A2A] dark:border-[#242535] bottom-0 left-4 sm:left-8 md:left-16 rounded-xl w-96 sm:w-[30rem] md:w-[35rem] lg:w-[40rem] h-auto sm:h-80 bg-white shadow-2xl p-6 sm:p-8 md:p-10 flex flex-col gap-4">
        {/* Category Badge */}
