  ...
  return (
    <div className="w-full h-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {card.map((item, index) => (
          <div key={index} className="border border-gray-200 p-6 bg-white rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-xl hover:scale-105">
            {/* Thumbnail */}
            <div
            ...
            <div className="pt-4">
              ...
              {/* Title */}
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black leading-tight mb-2">{item.title}</h3>
              {/* Profile Section */}
